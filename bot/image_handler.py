...
class ImageHandler:
    ...
    async def _get_unsplash_image(self) -> Optional[str]:
        ...
        try:
            search_term = random.choice([
                "young woman portrait", "girl aesthetic photo",
                "woman selfie style", "female model portrait",
                "cute girl photo"
            ])
            ...
            async with aiohttp.ClientSession() as session:
                ...
                unsplash_id = random.choice([
                    "494790108755-2616b612b75c", "517841905240-472988babdf9",
                    "524504388940-b1c1722653e1", "506863530036-1efeddceb993",
                    "488716820095-cbe80883c496", "573496359688-212c8331105b",
                    "580489944406-1439066c8a60", "598300042247-d088f8ab3a91"
                ])
    ...
    def get_random_aesthetic_context(self) -> str:
        ...
        contexts = [
            "Just woke up, morning vibes 🌅", "Coffee date with myself ☕💕",
            "Study break selfie 📚✨", "Late night mood 🌙",
            "Getting ready for the day 💄", "Lazy Sunday vibes 🛋️",
            "Missing someone special 🥺", "Feeling cute today 💖",
            "Room aesthetic check ✨", "Golden hour feels 🌅"
        ]
